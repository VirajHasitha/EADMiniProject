...
<body>
			...
			<div class="container">
				<div class="logo">
						<h1><a href="man_index.jsp">Design</a></h1>
				</div>
				<div class="ad-ph">
					<p>Call Us : <span>(77)</span>6219923</p>
				</div>
					<div class="clearfix"></div>
			</div>
		<!-- banner -->
				...
				<div class="container">
					<div class="services-bottom">
						...
						<h3>Repair Services</h3>
							<div class="ser-tp">
								<div class="ser-rt">
									<img src="../../images/module_ser1.jpg" class="img-responsive" alt="">
								</div>
								<div class="ser-lt">
							...
							<div class="ser-tp">
								<div class="ser-rt">
									<img src="../../images/module_ser2.jpg" class="img-responsive" alt="">
								</div>
								<div class="ser-lt">
